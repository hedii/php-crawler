...
var _SearchIndex = require('./components/SearchIndex.vue');

var _SearchIndex2 = _interopRequireDefault(_SearchIndex);

var _SearchCreate = require('./components/SearchCreate.vue');

var _SearchCreate2 = _interopRequireDefault(_SearchCreate);

var _SearchShow = require('./components/SearchShow.vue');

var _SearchShow2 = _interopRequireDefault(_SearchShow);

var _SearchActionsButtons = require('./components/SearchActionsButtons.vue');

var _SearchActionsButtons2 = _interopRequireDefault(_SearchActionsButtons);
...
if (document.body.classList.contains('searches-index') || document.body.classList.contains('searches-show') || document.body.classList.contains('searches-create')) {
    ...
    new Vue({
        ...
        methods: {},
        components: {
            SearchIndex: _SearchIndex2.default,
            SearchCreate: _SearchCreate2.default,
            SearchShow: _SearchShow2.default
        }
    });
}

},{"./components/SearchActionsButtons.vue":31,"./components/SearchCreate.vue":32,"./components/SearchIndex.vue":33,"./components/SearchShow.vue":34,"moment":1,"vue":28,"vue-resource":17}],31:[function(require,module,exports){
...
exports.default = {
    computed: {
        ...
        downloadResourcesUrl: function downloadResourcesUrl() {
            return baseUrl + '/resources';
        },
        countSearches: function countSearches() {
    ...
    methods: {
        deleteAllSearches: function deleteAllSearches() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/hedichaibi/Github/php-crawler/resources/assets/js/components/SearchActionsButtons.vue"
...
exports.default = {
    ...
    computed: {
        searchesIndexUrl: function searchesIndexUrl() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/hedichaibi/Github/php-crawler/resources/assets/js/components/SearchCreate.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
var _SearchActionsButtons = require('./SearchActionsButtons.vue');
...
exports.default = {
    ...
    methods: {
        getUserSearches: function getUserSearches() {
        ...
        getUserSearchesEveryFiveSeconds: function getUserSearchesEveryFiveSeconds() {
        ...
        deleteSearch: function deleteSearch(searchId) {
        ...
        viewSearchUrl: function viewSearchUrl(searchId) {
            return baseUrl + '/searches/' + searchId;
        },
        downloadSearchResourcesUrl: function downloadSearchResourcesUrl(searchId) {
    ...
    components: {
        SearchActionsButtons: _SearchActionsButtons2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/hedichaibi/Github/php-crawler/resources/assets/js/components/SearchIndex.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"./SearchActionsButtons.vue":31,"vue":28,"vue-hot-reload-api":3,"vueify-insert-css":29}],34:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n\n")
'use strict';
...
exports.default = {
    ...
    computed: {
        UserSearchesPageUrl: function UserSearchesPageUrl() {
            return baseUrl + '/searches';
        }
    },
    methods: {
        getSearchEverySecond: function getSearchEverySecond() {
            this.interval = setInterval(function () {
                this.getSearch(searchId);
            }.bind(this), 1000);
        },
        getSearch: function getSearch(searchId) {
        ...
        downloadSearchResourceUrl: function downloadSearchResourceUrl(searchId) {
            return baseUrl + '/searches/' + searchId + '/resources';
        },
        stopSearch: function stopSearch(searchId) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/hedichaibi/Github/php-crawler/resources/assets/js/components/SearchShow.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
